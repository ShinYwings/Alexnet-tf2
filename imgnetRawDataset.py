...
TRAIN_TFREC_DIR = r"D:\ILSVRC2012\256_imgnet_train"
TEST_TFREC_DIR = r"D:\ILSVRC2012\256_imgnet_val"
IMGNET_FILE_NAME= lambda name : '{}.JPEG'.format(name)
IMAGE_SIZE = 256
    ...
    for dir_path in splited_dir_list:
        ...
        for file_name in all_file_list[:5]:
            ...
            # else:
              ...
              image = convert_image_to_bytes(original_image)
              
              image_bytes = tf.image.encode_jpeg(image)
              tf.io.write_file(IMGNET_FILE_NAME(file_name), image_bytes)
