...
TRAIN_TFREC_DIR = r"D:\ILSVRC2012\95_tfrecord_train"
TEST_TFREC_DIR = r"D:\ILSVRC2012\95_tfrecord_val"
...
def parse_to_tfrecord(meta_data = "meta_data", splited_dir_list = "splited_dir_list", 
    ...
    for dir_path in splited_dir_list:
        ...
        for file_name in all_file_list[:10]:
...
if __name__ == "__main__":
  ...
  # split_number = math.ceil(len(train_dir_list) / 5)
